...
public class Main {
    public static void main(String[] args) {
        ...
        banda.actualizarInformacionBanda("Rock Alternativo", "Nueva historia");
        registrarYActualizarInformacion(banda);
        ...
        registrarYActualizarInformacion(album);
    ...
    // Método genérico para registrar y actualizar información de objetos que implementan la interfaz Informacion
    public static void registrarYActualizarInformacion(Informacion objeto) {
